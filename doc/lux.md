...
>     summary log       : /Users/hmattsso/dev/lux/tutorial/chatty/test/intro/lux_logs/run_2021_01_25_17_19_47_831222/lux_summary.log
...
>     summary           : FAIL
>     file:///Users/hmattsso/dev/lux/tutorial/chatty/test/intro/lux_logs/run_2021_01_25_17_19_47_831222/lux_summary.log.html
>     .../lux> echo $?
>     1
...
>     lrwxr-xr-x 1 hmattsso staff 30 Jan 25 18:19 lux_logs/latest_run -> run_2021_01_25_17_19_47_831222
>     .../lux> echo $?
>     0
...
>     summary log       : /Users/hmattsso/dev/lux/tutorial/chatty/test/intro/lux_logs/run_2021_01_25_17_20_29_290652/lux_summary.log
>     test case         : a_simple_server.lux
>     event log         : 0.6
>     /Users/hmattsso/dev/lux/tutorial/chatty/test/intro/a_simple_server.lux
>     18:20:29.388009 lux(0): start_time "2021-01-25 18:20:29.370094"
>     18:20:29.388385 lux(0): suite_timeout infinity
>     18:20:29.388503 lux(0): case_timeout 300000000 micros left (300 seconds * 1.000 multiplier)
>     18:20:29.389978 lux(1): doc "Demo a simple single shell test case"
>     18:20:29.393235 server(4): start "/Users/hmattsso/dev/lux/priv/bin/runpty /bin/sh -i"
>     18:20:29.393976 server(4): expected* ".+"
>     18:20:29.393976 server(4): timer started (10 seconds * 1.000 multiplier)
>     18:20:29.403029 server(4): recv "\e[?1034hsh-3.2$ "
>     18:20:29.403184 server(4): timer canceled (after 9052 micro seconds)
>     18:20:29.403342 server(4): match "\e[?1034hsh-3.2$ "
>     18:20:29.403342 server(4): rest ""
>     18:20:29.403698 server(4): send "export PS1=SH-PROMPT:
>         "
>     18:20:29.404017 server(4): recv "ex"
>     18:20:29.404145 server(4): recv "port PS1=SH-PROMPT:
>         "
>     18:20:29.404260 server(4): expected* "^SH-PROMPT:"
>     18:20:29.404260 server(4): timer started (10 seconds * 1.000 multiplier)
>     18:20:29.404495 server(4): recv "SH-PROMPT:"
>     18:20:29.404614 server(4): timer canceled (after 175 micro seconds)
>     18:20:29.404741 server(4): skip "export PS1=SH-PROMPT:
>         "
>     18:20:29.404741 server(4): match "SH-PROMPT:"
>     18:20:29.404741 server(4): rest ""
>     18:20:29.405165 server(6): send "erl -sname server -pa ../../../chatty/ebin
>         "
>     18:20:29.405475 server(6): recv "e"
>     18:20:29.405723 server(6): recv "rl -sname server -pa ../../../chatty/ebin
>         "
>     18:20:29.405879 server(8): expected* "Erlang/OTP"
>     18:20:29.405879 server(8): timer started (10 seconds * 1.000 multiplier)
>     18:20:29.520261 server(8): recv "Erlang/OTP 22 [erts-10.7.2.7] [source] [64-bit] [smp:12:12] [ds:12:12:10] [async-threads:1] [hipe]
>         
>         "
>     18:20:29.520447 server(8): timer canceled (after 114351 micro seconds)
>     18:20:29.520618 server(8): skip "erl -sname server -pa ../../../chatty/ebin
>         "
>     18:20:29.520618 server(8): match "Erlang/OTP"
>     18:20:29.520618 server(8): rest " 22 [erts-10.7.2.7] [source] [64-bit] [smp:12:12] [ds:12:12:10] [async-threads:1] [hipe]
>         
>         "
>     18:20:29.521261 server(9): expected* "Eshell"
>     18:20:29.521261 server(9): timer started (10 seconds * 1.000 multiplier)
>     18:20:29.641865 server(9): recv "Eshell V10.7.2.7  (abort with ^G)
>         "
>     18:20:29.642061 server(9): timer canceled (after 120604 micro seconds)
>     18:20:29.642243 server(9): skip " 22 [erts-10.7.2.7] [source] [64-bit] [smp:12:12] [ds:12:12:10] [async-threads:1] [hipe]
>         
>         "
>     18:20:29.642243 server(9): match "Eshell"
>     18:20:29.642243 server(9): rest " V10.7.2.7  (abort with ^G)
>         "
>     18:20:29.642479 server(9): recv "(server@HMATTSSO-M-74JD)1> "
>     18:20:29.642743 server(10): expected* "> "
>     18:20:29.642743 server(10): timer started (10 seconds * 1.000 multiplier)
>     18:20:29.642942 server(10): timer canceled (after 8 micro seconds)
>     18:20:29.643108 server(10): skip " V10.7.2.7  (abort with ^G)
>         (server@HMATTSSO-M-74JD)1"
>     18:20:29.643108 server(10): match "> "
>     18:20:29.643108 server(10): rest ""
>     18:20:29.643627 server(12): send "chatty:server().
>         "
>     18:20:29.643952 server(13): expected* "Starting server"
>     18:20:29.643952 server(13): timer started (10 seconds * 1.000 multiplier)
>     18:20:29.661630 server(13): recv "chatty:server()."
>     18:20:29.661823 server(13): recv "
>         "
>     18:20:29.668049 server(13): recv "** exception error: undefined function chatty:server/0
>         "
>     18:20:29.668243 server(13): recv "(server@HMATTSSO-M-74JD)2> "
>     18:20:39.644884 server(13): recv "match_timeout"
>     18:20:39.645505 server(13): timer failed (after 10001117 micro seconds)
>     18:20:39.645505 server(13): stop fail
>     18:20:39.645505 server(13): skip "chatty:server().
>         ** exception error: undefined function chatty:server/0
>         (server@HMATTSSO-M-74JD)2> "
>     18:20:39.645505 server(13): where "13"
>     18:20:39.645505 server(13): stack "a_simple_server.lux:13" expect 
>     18:20:39.645756 server(13): inactivate after delete
>     18:20:39.645856 lux(13): goto cleanup
>     18:20:39.646028 lux(22): no_cleanup
>     18:20:39.646134 lux(0): case_timeout 289742000 micros left (289 seconds * 1.000 multiplier)
>     18:20:39.646210 lux(0): suite_timeout infinity
>     18:20:39.646306 lux(0): end_time "2021-01-25 18:20:39.646297"
>     result            : FAIL at 13 in shell server
>     expected*
>     	Starting server
>     actual match_timeout
...
>     	a_simple_server.lux:13 - match_timeout
>     summary           : FAIL
>     file:///Users/hmattsso/dev/lux/tutorial/chatty/test/intro/lux_logs/run_2021_01_25_17_20_29_290652/lux_summary.log.html
>     .../lux> echo $?
>     1
...
>     Wrote 2448 bytes in run cache to file history_demo_multi_host/lux_history.cache
...
configurable. Here follows a few configuration pararamenters that may
...
mainly used to handle architecture specific quirks and are not
applicable during validation.
